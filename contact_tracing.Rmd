...
This interactive object is a visualization of the connections __from__ sources (cases) __to__ targets (contacts) in the `relationships` dataset. I strongly suggeest zooming in and out of the graph in your browser, clicking and dragging on the nodes helps make sense of the shapes together. The scale of the graph can zoom out pretty easily as well, so just reload this page if it gets lost in whitespace.  

Can we learn anything about this outbreak from the network graph?
